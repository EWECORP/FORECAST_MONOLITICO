...
/****** Object:  StoredProcedure [dbo].[SP_ZTRX_T_5_MOVIMIENTOS_DIARIOS]    Script Date: 24/10/2024 10:39:03 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER       PROCEDURE [dbo].[SP_ZTRX_T_5_MOVIMIENTOS_DIARIOS]
AS
BEGIN
    SET NOCOUNT ON;
