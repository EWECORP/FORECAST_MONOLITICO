...
/****** Object:  StoredProcedure [dbo].[SP_KIKKER_H_1_PEDIDOS_PENDIENTES_HISTORICOS]    Script Date: 19/06/2025 15:33:15 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[SP_KIKKER_H_1_PEDIDOS_PENDIENTES_HISTORICOS] @fecha char(10)
