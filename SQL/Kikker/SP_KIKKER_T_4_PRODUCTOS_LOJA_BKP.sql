...
/****** Object:  StoredProcedure [dbo].[SP_KIKKER_T_4_PRODUCTOS_LOJA_BKP]    Script Date: 19/06/2025 15:50:34 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[SP_KIKKER_T_4_PRODUCTOS_LOJA_BKP]
...
'1',--MIX
/*case when (ART.C_FAMILIA<>4 or SUC.M_HABILITADO_SUCU='S' and ART.M_A_DAR_DE_BAJA='N') then '1'--Habilitado Compra /*SIN FAMILIA A RENOVER, MARCA NADA, SIN MARCA A REMOVER*/
	 when (ART.C_FAMILIA=4 or SUC.M_HABILITADO_SUCU='N' and ART.M_A_DAR_DE_BAJA='S') then '0' end, /*CON FAMILIA A RENOVER, CON MARCA A REMOVER*/
case when SUC.M_LISTO_PARA_VENTA_SUCU='N' then '0' else '1' end, -- Habilitado para la venta
case when (ART.C_FAMILIA=4 and ART.M_A_DAR_DE_BAJA='S')  then '0' else '1' end,--Habilitado en MIX*/
