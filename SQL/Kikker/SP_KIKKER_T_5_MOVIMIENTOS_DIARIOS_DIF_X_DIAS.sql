...
/****** Object:  StoredProcedure [dbo].[SP_KIKKER_T_5_MOVIMIENTOS_DIARIOS_DIF_X_DIAS]    Script Date: 19/06/2025 15:52:16 ******/
SET ANSI_NULLS ON
GO
...
CREATE procedure [dbo].[SP_KIKKER_T_5_MOVIMIENTOS_DIARIOS_DIF_X_DIAS]
AS
BEGIN
...
declare @fecha as dateTIME = getdate()-3; ---- HERNAN LOPEZ 03/08/2022
DECLARE @FECHA_HASTA AS DATETIME = GETDATE()-2 ---- HERNAN LOPEZ 03/08/2022
