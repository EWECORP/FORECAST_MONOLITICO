...
/****** Object:  StoredProcedure [dbo].[SP_KIKKER_T_4_PRODUCTOS_LOJA_BKP_20112023]    Script Date: 19/06/2025 15:50:55 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[SP_KIKKER_T_4_PRODUCTOS_LOJA_BKP_20112023]
...
case when (ART.C_FAMILIA = 4 or ART.M_A_DAR_DE_BAJA='S' or SUC.M_HABILITADO_SUCU = 'N')  then '0' else '1' end, -- habilitado compra
