...
5) ACTUALIZAR Nuevos esquemas segmentados por módulo.  PUBLIC --> supply_planning
    ...
    for i, row in df_forecast_ext.iterrows():
        try:
            ...
            fila = (
                ...
                safe_int(row.get('Q_DIAS_STOCK', 0)) + safe_int(row.get('Q_DIAS_SOBRE_STOCK', 0)) + safe_int(row.get('DIAS_PREPARACION', 0)),
                0,
