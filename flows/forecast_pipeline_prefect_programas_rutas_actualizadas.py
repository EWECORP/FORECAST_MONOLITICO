...
@flow(name="pipeline_forecast_programas_rutas_actualizadas")
def forecast_pipeline_diario():
    ejecutar_script.submit("S10 - Forecast Planificado", 10, "S10_GENERA_FORECAST_Planificado.py")
    ejecutar_script.submit("S20 - Forecast Extendido", 20, "S20_GENERA_FORECAST_Extendido.py")
    ejecutar_script.submit("S30 - Generación de Gráficos", 30, "S30_GENERA_Grafico_Detalle.py")
    ejecutar_script.submit("S40 - Subida a Connexa", 40, "S40_SUBIR_Forecast_Connexa.py")
    ejecutar_script.submit("S90 - Publicación OC", 90, "S90_PUBLICAR_OC_PRECARGA.py")
