...
def run_supplier_sync():
    ...
    try:
        ...
        logging.info(f"Total de proveedorers obtenidos desde origen: {cantidad}")
        ...
        logging.info(f"Total de proveedorers obtenidos desde destino: {cantidad}")
        ...
        logging.info(f"Cantidad de proveedores a insertar: {len(filas_ins)}")
        logging.info(f"Cantidad de proveedores a actualizar: {len(filas_upd)}")
